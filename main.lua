...
Main = (function()
	...
	Main.Apps = Apps
	Main.MenuApps = {}
	Main.GitName = "rileybeerblx1"
	Main.RepoName = "DexEclipse"
	...
	Main.SecureGui = function(gui)
		...
		gui.Name = "_DEC_".. Main.GetRandomString()
	...
	Main.IncompatibleTest = function()
		--[[local function incompatibleMessage(reason, tolerated)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nHello Skidsploit user,\nZinnia, Riley and the Secret Service does not approve of Dex being used on your skidsploit.\nPlease consider getting something better.\n\nIncompatible Reason: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.LoadSettings = function()
		local s, data = pcall(env.readfile or error, "DexECSettings.json")
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Dex: Eclipse",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Riley.",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "Close" or "DexEC"
	...
	Main.SaveCurrentSettings = function()
		if writefile then
			writefile("DexECSettings.json", Main.ExportSettings())
		end
	end
	...
	Main.Init = function()
		...
		if isfile and not isfile("DexECSettings.json") then
		...
		API = Main.FetchAPI(
			...
			function()
				intro.SetProgress("This is taking longer than expected... (Fetching API)",0.45)
			end,
			function()
				intro.SetProgress("Still fetching... This may be caused by bad internet connection or taking too long to load(Fetching API)",0.475)
			end
		)
		Lib.FastWait()
	...
	Main.Uninit = function()
		...
		for _, gui in pairs(Main.GetSecureContainer():GetChildren()) do
			if string.sub(gui.Name,1,5) == "_DEC_" then -- DEC stands for Dex: Eclipse
				gui:Destroy()
			end
		end
	end
